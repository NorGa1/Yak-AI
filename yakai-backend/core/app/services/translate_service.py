...
model_path = "D:/code/nllb-tibetan-chinese-small/nllb-tibetan-chinese-small/best_model"#"C:/Users/luorijia/.cache/modelscope/hub/models/facebook/nllb-200-distilled-600M"
...
# async def stream_translate_nllb(text: str, src_lang: str, tgt_lang: str):
#     """
#     Stream translation with NLLB model
#     """
#     try:
#         tokenizer.src_lang = src_lang
#         inputs = tokenizer(
...
#             )
#             partial = ""
#             async for generated_tokens in outputs:
